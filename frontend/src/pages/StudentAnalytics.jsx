...
export default function StudentAnalytics() {
  ...
  const [selectedStudent, setSelectedStudent] = useState(user.role === 'student' ? user.id : null);
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-600">
                      {analytics.analytics.performance_metrics.average_grade.toFixed(1)}%
                    </p>
                  </div>
                  <Award className="w-8 h-8 text-blue-500" />
                </div>
                <p className="text-xs text-gray-500 mt-2">
                  {analytics.analytics.performance_metrics.total_assessments} assessments
                </p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600 capitalize">
                      {analytics.analytics.grade_trends.trend_direction}
                    </p>
                  </div>
                  <TrendingUp className="w-8 h-8 text-green-500" />
                </div>
                <p className="text-xs text-gray-500 mt-2">
                  Consistency: {analytics.analytics.grade_trends.consistency_score.toFixed(1)}%
                </p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-600">
                      {analytics.analytics.strengths_weaknesses.strengths.length}
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-600">
                      {analytics.analytics.study_recommendations.length}
                    </p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'trends' && analytics && (
              <div className="space-y-6">
                <GradeTrendChart 
                  ...
                  detailed={true}
                />
                {/* Additional trend analysis components */}
              </div>
            )}
            ...
            {activeTab === 'attendance' && analytics && (
              <div className="space-y-6">
                ...
                {/* Additional attendance analysis */}
              </div>
            )}
